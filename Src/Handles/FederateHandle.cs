...
{
    public sealed class FederateHandle : UnmanagedHlaObject
    {
        ...
        public static bool operator ==(FederateHandle a, FederateHandle b)
        {
            throw new System.NotImplementedException("This is a reference assembly.");
        }
        ...
        public bool Equals(FederateHandle other)
        {
            throw new System.NotImplementedException("This is a reference assembly.");
        }
    }
